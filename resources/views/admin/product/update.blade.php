                        ...
                        <div class="row d-flex gap-2">
                            ...
                            <div class="col-md-7 section1">
                                 ...
                                 <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="company_name" id="company_name" class="form-control" value="{{ old('company_name', $product->company_name) }}">
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="hidden" name="main_image[0]" id="main_image_base64">
                                </div>
                                ...
                                <div class="form-group mb-3 col-md-6">
                                    ...
                                    <input type="text" name="flavour" id="flavour" class="form-control" value="{{ old('flavour', $product->flavour) }}" >
                                </div>
